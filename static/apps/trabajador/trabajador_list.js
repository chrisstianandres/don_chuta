    ...
    var datatable = $("#datatable").DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                width: '10%',
                render: function (data, type, row) {
                    var edit = '<a type="button" class="btn btn-success btn-xs" data-toggle="tooltip" title="Editar Datos" href="/empleado/editar/' + row[0] + '"><i class="fa fa-user-edit"></i></a>' + ' ';
                    var estado = '<a type="button" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Gestionar Estado" rel="estado"> <i class="fa fa-user-cog"></i></a>';
                    return edit + estado;
                }
            },
            {
        ...
        createdRow: function (row, data, dataIndex) {
            if (data[8] === 'ACTIVO') {
                $('td', row).eq(8).find('span').addClass('badge bg-info');
            } else if (data[8] === 'INACTIVO') {
                $('td', row).eq(8).find('span').addClass('badge bg-important');
            }
